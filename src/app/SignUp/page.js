...
export default function SignUpForm() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-cover bg-center bg-white">
      <div className="fixed top-0 left-0 w-full flex items-center justify-between p-4 sm:p-10 z-60">
        <div className="h-16 pl-6 sm:pl-9">
          <Image
            src="/image.png"
            alt="Logo"
            className="h-full"
      ...
      <div className="bg-white p-6 sm:p-8 w-full max-w-md mx-4 mt-20">
        <h2 className="text-xl sm:text-2xl font-semibold mb-6 text-center text-black">Sign Up</h2>
