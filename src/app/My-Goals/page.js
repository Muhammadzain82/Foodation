...
const goalsList = [
  { id: 1, title: 'Donate a basket of fruit', enrolled: '2, apples, 4 bananas', points: 200 },
  { id: 2, title: 'Donate a basket of fruit', enrolled: '2, apples, 4 bananas', points: 200 },
  { id: 3, title: 'Donate a basket of fruit', enrolled: '2, apples, 4 bananas', points: 200 },
  { id: 4, title: 'Donate a basket of fruit', enrolled: '2, apples, 4 bananas', points: 200 },
  { id: 5, title: 'Donate a basket of fruit', enrolled: '2, apples, 4 bananas', points: 200 },
  { id: 6, title: 'Donate a basket of fruit', enrolled: '2, apples, 4 bananas', points: 200 },
]
          ...
          <div className="flex-1 bg-white rounded-lg shadow-sm mr-8">
            <div className="p-6">
              ...
              <div className="flex space-x-4 mb-6">
                ...
                <button className="px-4 py-2 text-green-500 bg-green-100 rounded-full">My Goals</button>
                <button className="px-4 py-2 text-gray-500 hover:bg-gray-100 rounded-full"> 
                  ...
                  <div key={goal.id} className="flex items-center justify-between p-4 border rounded-lg">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-gray-500">{goal.enrolled}</div>
                    ...
                    <div className="flex items-center space-x-4">
                      <div className="text-green-500">+{goal.points}
                       <Image src="/coin.png" width={32} height={32}/>
                      </div>
                      <button className="px-4 py-2 text-white bg-green-500 rounded hover:bg-green-600">
                        Complete Now
                      </button>
              ...
              <div className="p-6">
                ...
                <div className="space-y-4">
                  {leaderboard.map((user, index) => (
                    <div key={user.id} className="flex items-center justify-between text-green-500">
