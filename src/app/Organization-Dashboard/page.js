            ...
            <div key={goal.id} className="flex items-center space-x-4 mb-4 p-4 bg-green-50 rounded-lg">
              ...
              <div className="flex-grow">
                ...
                <div className="flex items-center mt-2">
                  ...
                  <span className="text-xs text-gray-500">{goal.enrolled}/{goal.total} enrolled</span>
                </div>
              </div>
              <div className="flex flex-col items-end">
                <span className="text-green-500 font-semibold"><Image src="/coin.png" width={40} height={40}/>+200{goal.amount}</span>
              </div>
            </div>
          ))}
        </div>
