...
const goalsList = [
  { id: 1, title: 'Donate a basket of fruit', enrolled: '22/40', points: 200 },
  { id: 2, title: 'Donate a basket of fruit', enrolled: '22/40', points: 200 },
  { id: 3, title: 'Donate a basket of fruit', enrolled: '22/40', points: 200 },
  { id: 4, title: 'Donate a basket of fruit', enrolled: '22/40', points: 200 },
  { id: 5, title: 'Donate a basket of fruit', enrolled: '22/40', points: 200 },
  { id: 6, title: 'Donate a basket of fruit', enrolled: '22/40', points: 200 },
  { id: 7, title: 'Donate a basket of fruit', enrolled: '22/40', points: 200 },
]

const leaderboard = [
  { id: 1, name: 'Amitah', donations: '34.5k', points: 44 },
  { id: 2, name: 'Amitah', donations: '34.5k', points: 44 },
  { id: 3, name: 'Amitah', donations: '34.5k', points: 44 },
  { id: 4, name: 'Amitah', donations: '34.5k', points: 44 },
]
  ...
  return (
    <div className="flex min-h-screen bg-white">
      ...
      <div className="w-64 bg-white shadow-md">
        ...
        <button className="w-full mt-4 px-4 py-2 bg-green-500 text-white rounded-full">
          Create Goal
        </button>
        <nav className="mt-8">
          ...
          <div className="flex-1 bg-white rounded-lg shadow-sm mr-8">
            <div className="p-6">
              ...
              <div className="flex space-x-4 mb-6">
                <button className="px-4 py-2 text-green-500 bg-green-100 rounded-full">Unfinished Goals</button>
              ...
              <button className="mt-4 px-4 py-2 bg-green-500 text-white rounded-full w-full">
                Create New goal
              </button>
            </div>
          </div>
